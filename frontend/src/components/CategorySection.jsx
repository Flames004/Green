...
const CategorySection = () => {
  return (
    <div className='mx-10 bg-gray-100  rounded-lg px-5 md:px-15'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4  md:gap-6 pb-5 md:pb-10'>
